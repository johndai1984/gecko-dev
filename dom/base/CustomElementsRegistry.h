...
struct CustomElementDefinition
{
  ...
  RefPtr<mozilla::dom::Function> mConstructor;
  // A list of observed attributes
  nsTArray<nsString> observedAttributes;
...
class CustomElementsRegistry final : public nsISupports /* or NonRefcountedDOMObject if this is a non-refcounted object */,
...
private:
  ...
  nsTHashtable<nsPtrHashKey<mozilla::dom::Function>> mConstructors;
...
public:
  ...
  void Define(JSContext* aCx, const nsAString& aName, Function& aFunctionConstructor,
