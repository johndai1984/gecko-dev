...
class CGCallGenerator(CGThing):
    ...
    def __init__(self, isFallible, needsSubjectPrincipal, needsCallerType,
        ...
        #print "descriptor.interface:", descriptor.interface
...
class CGPerSignatureCall(CGThing):
    ...
    def __init__(self, returnType, arguments, nativeMethodName, static,
        ...
        if idlNode.getExtendedAttribute('CEReactions') is not None:
            cgThings.append(CGGeneric("AutoCEReaction ceReaction;\n"))
...
class CGSpecializedForwardingSetter(CGSpecializedSetter):
    ...
    def definition_body(self):
        ...
        ceReaction = "AutoCEReaction ceReaction;" if self.attr.getExtendedAttribute("CEReactions") else ""
...
class CGBindingRoot(CGThing):
    ...
    def __init__(self, config, prefix, webIDLFile):
        ...
        bindingHeaders["mozilla/dom/CustomElementRegistry.h"] = any(
            descriptorCEReactions(d) for d in descriptors)
